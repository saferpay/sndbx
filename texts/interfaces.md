...
- **You want to execute refunds via the API:** [Refunds via API](refund.html) (Note, that refunds are also possible via the Saferpy Backoffice!), are only possible with the transaction interface and a Saferpay Business license.

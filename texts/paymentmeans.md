...
<div id="visa-cards-hider" style="display:none;">
  ...
  <table class="table table-striped table-hover">
      ...
      <tr>
          ...
          <td style="border-left: 1px solid #ddd;">Card for simulating response codes via the amount. The last two digits inside the amount are important. Down below you'll find some examples for return-codes/amounts. <strong>Important Note:</strong> These are the most common codes! However some Issuers may return codes not on this list!<br /><strong>Liability shift:</strong> true, <strong>Authenticated:</strong> true<br />
          <table class="table table-striped table-hover">
            <thead>
              <tr>
                <th>Amount</th>
